...
namespace Foam
{
    defineTypeNameAndDebug(hotWireControl, 0);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::hotWireControl::read()
{
    solutionControl::read(true);
}


bool Foam::hotWireControl::criteriaSatisfied()
{
...
Foam::hotWireControl::hotWireControl(fvMesh& mesh)
:
    solutionControl(mesh, "RHOCONTROL"),
    initialised_(false)
{
    read();
...
Foam::hotWireControl::~hotWireControl()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::hotWireControl::loop()
{
    read();
    ...
    if (initialised_)
    {
        ...
        {
            Info<< nl << algorithmName_ << " solution converged at "
                << time.timeName() << " s " << nl << endl;
